...
window.addEventListener('touchend', e => {
  ...
  const guestsNames = decode(decodeURI(search).split("=")[1]);

  // console.log(unicodeToChar(guestsNames));

  // // const decoder = new Buffer.from(encoder).to('base64')

  // // console.log(encoder,decoder);

  // // убираю первое слово "дорогие"
  const hookContent = `${guestsNames.split(" ").slice(1).join(" ")}`;
  ...
  const handleApprove = () => {
    ...
    axios.post(
      "https://discord.com/api/webhooks/1209521955510816819/bkC1TN7-nskrx_PBR26ZJHs197mnqU6FB69atSq155I_g9tbLycgO-N2zYsJJe_TVHuB",
      { content: hookContent }
    );
  ...
  return (
    ...
    <div className="content">
      <div className="card">
        ...
        <br />
        Дата: {isOfficial ? '29 марта в 17:00' : '30 марта в 15:00'}
        <br />
        {isOfficial ? '' : 'Дресс-код: свободный'}
        <br />
        Искренне ваши, Андрей и Алиса
      </div>
